...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrAGR.Entities.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GrAGR.Entities.ClientOrders", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppClientOrders");
                });

            modelBuilder.Entity("GrAGR.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GrAGR.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GrAGR.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GrAGR.Entities.Position", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GrAGR.Entities.ClientOrders", b =>
                {
                    b.HasOne("GrAGR.Entities.Client", "Client")
                        .WithMany()
                        .HasForeignKey("IdClient")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrAGR.Entities.Order", "Order")
            ...
            modelBuilder.Entity("GrAGR.Entities.Employee", b =>
                {
                    b.HasOne("GrAGR.Entities.Position", "Position")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("GrAGR.Entities.Order", b =>
                {
                    b.HasOne("GrAGR.Entities.Organization", "Organization")
                        .WithMany("Orders")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrAGR.Entities.Employee", "Receptionist")
                        .WithMany("Orders")
